<?php
  ...
  while($row=mysqli_fetch_array($result_check,MYSQLI_ASSOC)) {
    ...
    $html.='<td>'.$i.'</td>';
    $html.='<td>'.$row["id"].'</td>';
    $html.='<td class="name">'.$row["name_ideal_for"].'</td>';
    $html.='<td class="url-name">'.$row["url_name_ideal"].'</td>';

    $html.='<td class="button"><a href="edit-ideal-for-product.php?id='.$row["id"].'" class="btn-edit">Edit</a></td>';
    $html.='<td class="button"><a onclick="return confirmdelete()" href="c-delete-ideal-for-product.php?id='.$row["id"].'" class="btn-delete">Delete</a></td>';
    $html.='</tr>';
  }
        ...
        <section class="name-main-right">
          <div class="title-bar">
            ...
            <div class="title-right">
              <form method="post" action="ideal-for-product.php" class="form-search">
                ...
                <a href="add-ideal-for-product.php" class="submit-btn btn-add">
                  Thêm Loại
            ...
            <table class="member">
                <thead>
                    <tr>
                        <th>STT</th>
                        <th>ID</th>
                        <th>Tên Giới Tính Thích Hợp</th>
                        <th>URL Giới Tính Thích Hợp</th>
      ...
      <div class="bottom-main-right">
        <div class="nav-btom">
          <div class="txt-nav-bottom">
            <b>Tổng cộng số Giới Tính Thích Hợp : </b>
            <span>
              <?php
                echo $count;
              ?>
