<?php
  ...
  include "c-count.php";
  $query_check  = 'SELECT * FROM pd_species';
  ...
  while($row=mysqli_fetch_array($result_check,MYSQLI_ASSOC)) {
    ...
    $html.='<td>'.$i.'</td>';
    $html.='<td>'.$row["id"].'</td>';
    $html.='<td class="name">'.$row["name_species"].'</td>';
    $html.='<td class="url-name">'.$row["url_name_species"].'</td>';
    $html.='<td>'.$row["describe_species"].'</td>';

    $html.='<td class="button"><a href="edit-species-product.php?id='.$row["id"].'" class="btn-edit">Edit</a></td>';
    $html.='<td class="button"><a onclick="return confirmdelete()" href="c-delete-species-product.php?id='.$row["id"].'" class="btn-delete">Delete</a></td>';
    $html.='</tr>'; 
  }
        ...
        <section class="name-main-right">
          <div class="title-bar">
            <div class="title-left">
              <p class="dashboard">Control Table - Species Product</p>
            </div>
            <div class="title-right">
              <form method="post" action="species-product.php" class="form-search">
                ...
                <button type="submit" name="submit-btn" class="submit-btn">Search Species</button>
                <button type="submit" name="refesh-btn" class="submit-btn">refesh Table</button>
                <a href="add-species-product.php" class="submit-btn btn-add">
                  Thêm Loại
