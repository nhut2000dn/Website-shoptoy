<?php
  ...
  while($row=mysqli_fetch_array($result_check,MYSQLI_ASSOC)) {
    ...
    $html.='<td class="button"><a href="add-amount-product.php?id='.$row["id_pd"].'" class="btn-edit">Add</a></td>';
    $html.='<td class="button"><a onclick="return confirmdelete()" href="c-delete-product.php?id='.$row["id_pd"].'" class="btn-delete">Delete</a></td>';
    $html.='</tr>'; 
  }
...
<head>
  ...
  <link rel="stylesheet" href="css/css-out-of-stock.css">
        ...
        <section class="name-main-right">
          <div class="title-bar">
            <div class="title-left">
              <p class="dashboard">Control Table - Out Of Stock</p>
            </div>
