<?php
  ...
  while($row=mysqli_fetch_array($result_check,MYSQLI_ASSOC)) {
    ...
    $html.='<td>'.$i.'</td>';
    $html.='<td>'.$row["id"].'</td>';
    $html.='<td class="name">'.$row["name_r_age"].'</td>';
    $html.='<td class="url-name">'.$row["url_name_r_age"].'</td>';

    $html.='<td class="button"><a href="edit-r-age-product.php?id='.$row["id"].'" class="btn-edit">Edit</a></td>';
    $html.='<td class="button"><a onclick="return confirmdelete()" href="c-delete-r-age-product.php?id='.$row["id"].'" class="btn-delete">Delete</a></td>';
    $html.='</tr>';
  }
          ...
          <div class="title-bar">
            ...
            <div class="title-right">
              <form method="post" action="species-product.php" class="form-search">
                ...
                <a href="add-r-age-product.php" class="submit-btn btn-add">
                  Thêm Loại
            ...
            <table class="member">
                <thead>
                    <tr>
                        <th>STT</th>
                        <th>ID</th>
                        <th>Tên Tuổi Thích Hợp</th>
                        <th>URL Tuổi Thích Hợp</th>
      ...
      <div class="bottom-main-right">
        <div class="nav-btom">
          <div class="txt-nav-bottom">
            <b>Tổng cộng số Tuổi Thích Hợp : </b>
            <span>
              <?php
                echo $count;
              ?>
