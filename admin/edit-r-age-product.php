<?php
    ...
    $idRAge = $_GET["id"];
    $query_check  = 'SELECT * FROM pd_recommended_age WHERE id="'.$idRAge.'"';
    ...
    if (isset($_POST["submit-btn"])) {
        ...
        if ($check == true) {
            ...
            $queryUpdate  = "UPDATE pd_recommended_age SET name_r_age=N'$nameRAge', url_name_r_age=N'$urlNameRAge' WHERE id='$idRAge'";
...
<body>
  ...
  <div class="main-left">
    ...
    <div class="main-right">
      ...
      <form action="<?php echo "edit-r-age-product.php?id=$idRAge" ?>" method="post">
        <table>
            <tbody>
                <tr><td><span>Tên Loại</span></td></tr>
                <tr><td><input name="nameRAge" type="text" placeholder="Nhập Tên Loại" value="<?php if(isset($nameRAge)) echo $nameRAge;?>"></td></tr>
                <tr>
                    <td>
