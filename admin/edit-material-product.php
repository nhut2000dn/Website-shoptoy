<?php
    ...
    $idMaterial = $_GET["id"];
    $query_check  = 'SELECT * FROM pd_material WHERE id="'.$idMaterial.'"';
    ...
    while ($row=mysqli_fetch_array($result_check, MYSQLI_ASSOC)) {
        $nameMaterial = $row["name_material"];
    }
    $error;
    $check = true;
    if (isset($_POST["submit-btn"])) {
        ...
        if ($check == true) {
            ...
            $queryUpdate  = "UPDATE pd_material SET name_material=N'$nameMaterial', url_name_material=N'$urlNameMaterial' WHERE id='$idMaterial'";
...
<body>
  ...
  <div class="main-left">
    ...
    <div class="main-right">
      ...
      <form action="<?php echo "edit-material-product.php?id=$idMaterial" ?>" method="post">
        <table>
            <tbody>
                <tr><td><span>Tên Loại</span></td></tr>
                <tr><td><input name="nameMaterial" type="text" placeholder="Nhập Tên Loại" value="<?php if(isset($nameMaterial)) echo $nameMaterial;?>"></td></tr>
                <tr>
                    <td>
